...
#
# Output:
#  - manuscripts/ch3/tables/Table_archetype_scores_CHS41.csv (NC_Full repo)
#
...
P_PERPLOT <- file.path(RMUSICA, "out_files/Chapter3_CHS41/tables",
                       "perplot_dtmax_conventions_CHS41.csv")
...
P_OUT     <- file.path(NC_FULL, "manuscripts/ch3/tables",
                       "Table_archetype_scores_CHS41.csv")
...
SCEN <- c(
  # The four chapter scenarios, all complete at 53 plots under the CHS41 forcing
  # without wind correction. STATIC_S2_RESCALED (the static form of the
  # combination) stops at 47 plots and reproduces the LiDAR run on 49 of 53, so
  # the combination is carried by its dynamic form.
