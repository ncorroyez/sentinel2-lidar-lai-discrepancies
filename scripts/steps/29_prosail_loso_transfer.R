...
#   Rscript scripts/steps/29_prosail_loso_transfer.R
# ---
...
# ── Configuration — must match scripts/steps/12_sm5_select_prosail_opt.R ──────

norm_select         <- "DSM_keepTrees"
h_min_select        <- 10L
lai_scenario_select <- "common"
max_depth           <- 10L      # d_thr; matches scripts/steps/06_sm5_select_dopt.R
...
loso <- rbindlist(lapply(sites, function(s_out) {
  ...
  # Pareto rule (scripts/steps/06_sm5_select_dopt.R). (C2) re-runs that Pareto
