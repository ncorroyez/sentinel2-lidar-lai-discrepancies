...
#   source("scripts/ch2/01_prepare.R")
# ---
...
step("scripts/ch2/steps/02a_train_prosail_atbd.R")
step("scripts/ch2/steps/03a_sample_s2_pixels.R")
step("scripts/ch2/steps/03b_extract_lidar_at_samples.R")
step("scripts/ch2/steps/04a_apply_prosail_atbd.R")
