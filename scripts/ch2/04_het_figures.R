...
#   source("scripts/ch2/04_het_figures.R")
# ---
...
step("scripts/ch2/steps/20_sm6_plot_heterogeneity.R")
step("scripts/ch2/steps/20d_sm6_heter_continuous.R")
step("scripts/ch2/steps/21_sm6_density_scatter.R")
step("scripts/ch2/steps/23_plot_s2_reflectance_histograms.R")
step("scripts/ch2/steps/26_plot_als_metrics_scatter.R")
step("scripts/ch2/steps/27_plot_max_height_density.R")
step("scripts/ch2/steps/28_plot_pad_profiles.R")
