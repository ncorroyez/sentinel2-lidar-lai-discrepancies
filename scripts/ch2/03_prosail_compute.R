...
#   source("scripts/ch2/03_prosail_compute.R")
# ---
...
step("scripts/ch2/steps/09_train_prosail_full.R")
step("scripts/ch2/steps/10_apply_prosail_full.R")
step("scripts/ch2/steps/11_sm5_compute_metrics_full.R")
step("scripts/ch2/steps/12_sm5_select_prosail_opt.R")
step("scripts/ch2/steps/13_sm5_predict_lai_raster.R")
step("scripts/ch2/steps/25_train_apply_prosail_atbd_rasters.R")
