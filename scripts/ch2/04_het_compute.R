...
#   source("scripts/ch2/04_het_compute.R")
# ---
...
step("scripts/ch2/steps/14_sm6_compute_heterogeneity.R")
step("scripts/ch2/steps/15_sm6_analysis.R")
step("scripts/ch2/steps/16_sm6_analysis_sweep.R")
