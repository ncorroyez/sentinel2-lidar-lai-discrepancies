...
#   source("scripts/ch2/02_dopt_compute.R")
# ---
...
# step("scripts/ch2/steps/05a_sm5_compute_metrics_atbd.R")
step("scripts/ch2/steps/05c_sm5_k_zmin_sensitivity_dopt.R")
step("scripts/ch2/steps/06_sm5_select_dopt.R")
step("scripts/ch2/steps/07_compute_lai_als_dopt.R")
