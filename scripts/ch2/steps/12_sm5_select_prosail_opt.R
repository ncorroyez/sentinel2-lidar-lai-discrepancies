...
#   source("scripts/ch2/steps/06b_sm5_select_prosail_opt.R")
# ---
...
# MUST match scripts/ch2/steps/06_sm5_select_dopt.R for consistency.
...
cat("# PROSAIL Pareto selection — summary\n\n",
    "Generated by `scripts/ch2/steps/12_sm5_select_prosail_opt.R`.  \n",
