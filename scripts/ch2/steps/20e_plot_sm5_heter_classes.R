...
#         scripts/ch2/steps/20e_sm5_heter_classes.R. Uses the shared
#         plot_het_grid() helper so the figure style is identical to
#         scripts/ch2/steps/20_sm6_plot_heterogeneity.R (which uses the SM6a
#         pixel sample).
#
#         Reads:
...
#   source("scripts/ch2/steps/20e_plot_sm5_heter_classes.R")
# ---
