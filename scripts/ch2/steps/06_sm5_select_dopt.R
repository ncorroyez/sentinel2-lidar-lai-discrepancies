...
#           Run scripts/ch2/05_sm5_compute_metrics.R first.
#
# Run from the project root (NC_Full/):
#   source("scripts/ch2/06_sm5_select_dopt.R")
# ---
...
if (use_reference) {
  ...
  if (!file.exists(sm5_csv))
    stop("SM5a ATBD CSV not found:\n  ", sm5_csv,
         "\nRun scripts/ch2/steps/05a_sm5_compute_metrics_atbd.R first.")
  ...
  if (!file.exists(kt_csv))
    stop("kt CSV not found:\n  ", kt_csv,
         "\nRun scripts/ch2/steps/05c_sm5_k_zmin_sensitivity_dopt.R first.")
