...
#   source("scripts/ch2/03_prosail_figures.R")
# ---
...
step("scripts/ch2/steps/12b_sm5_plot_prosail_pareto.R")
step("scripts/ch2/steps/22_sm5_plot_prosail_param_distributions.R")
step("scripts/ch2/steps/24_plot_s2_atbd_validation.R")
step("scripts/ch2/steps/08_sm5_scatter_lai_atbd.R")   # ATBD_T raster from 25
