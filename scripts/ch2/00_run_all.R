...
#   source("scripts/ch2/00_run_all.R")
#
...
#
#   nbSamples = 5000              scripts/ch2/steps/03a_sample_s2_pixels.R
#   h_min sweep = c(10, 15, 20)   scripts/ch2/steps/03a_sample_s2_pixels.R
#                                 (dthr in the manuscript)
#   sampling method = stratified_uniform
#                                 scripts/ch2/steps/03a_sample_s2_pixels.R
...
#                                 scripts/ch2/steps/06_sm5_select_dopt.R
#                                 scripts/ch2/steps/07_compute_lai_als_dopt.R
#                                 scripts/ch2/steps/18_fcover_sensitivity.R
#                                 scripts/ch2/steps/19_h_min_sensitivity.R
#                                 scripts/ch2/steps/20_fcover_hmin_joint_sensitivity.R
#                                 (rescaled via rescale_lai_for_k() — R/k_sensitivity.R)
#   theta_select = 0              scripts/ch2/steps/06_sm5_select_dopt.R
#   d_opt selection method = pareto
#                                 R/sm5_dopt.R (select_dopt) and step 06
#   combined_mode = average       scripts/ch2/steps/06_sm5_select_dopt.R
#
#   PROSAIL LAI scenarios         scripts/ch2/steps/09_train_prosail_full.R
#   LUT base config = ATBD v2     R/prosail_lut.R (get_atbd_lut_input)
#   soil spectrum = atbd_v2       R/prosail_lut.R (spec_soil_atbd_v2)
#
#   k sweep = {0.4, 0.5, 0.6}     scripts/ch2/steps/17_k_sensitivity.R
#   fCover sweep = {0.80…0.95}    scripts/ch2/steps/18_fcover_sensitivity.R
#   h_min sweep                   scripts/ch2/steps/19_h_min_sensitivity.R
# ---
...
phase("scripts/ch2/01_prepare.R")

# ── Phase 2 : d_opt selection + LAI_ALS_dopt rasters ─────────────────────────
phase("scripts/ch2/02_dopt_compute.R")
phase("scripts/ch2/02_dopt_figures.R")

# ── Phase 3 : PROSAIL full inversion + LAI_S2_opt rasters ────────────────────
phase("scripts/ch2/03_prosail_compute.R")
phase("scripts/ch2/03_prosail_figures.R")

# ── Phase 4 : Heterogeneity analysis (SM6) ───────────────────────────────────
phase("scripts/ch2/04_het_compute.R")
phase("scripts/ch2/04_het_figures.R")

# ── Phase 5 : Sensitivity analyses ───────────────────────────────────────────
phase("scripts/ch2/05_sensitivity.R")
phase("scripts/ch2/05_sensitivity_figures.R")
